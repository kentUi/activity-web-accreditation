                                                                            ...
                                                                            @else
                                                                                @foreach ($ins_response as $rw)
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="text-center">
                                                                                            <a href="/program/higher/area/{{ $rw->ins_id }}"
                                                                                                class="btn btn-xs btn-primary">
                                                                                                Proceed &nbsp;<span
                                                                                                    class="ni ni-arrow-right"></span>
                                                                                            </a>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="create-folder">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('prog.area.create') }}" autocomplete="off">
                    @csrf
                    <div class="modal-body modal-body-md">
                        <div class="nk-upload-form">
                            <h5 class="title mb-3">Create Area</h5>
