...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 10, 2023 at 12:19 PM
...
INSERT INTO `t_areas` (`ins_id`, `ins_text`, `ins_code`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE IF NOT EXISTS `t_instruments` (
  `ins_id` int NOT NULL AUTO_INCREMENT,
  `ins_text` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ins_type` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`ins_id`)
...
INSERT INTO `t_instruments` (`ins_id`, `ins_text`, `ins_type`, `created_at`, `updated_at`) VALUES
(1, 'Bachelor of Science in Information Technology', 'OBE Instruments', '2023-12-10 05:13:57', '2023-12-09 21:13:57'),
(2, 'Bachelor of Science in Electrical Engineering', 'OBE Instruments', '2023-12-10 04:20:14', '0000-00-00 00:00:00'),
(3, 'Bachelor of Science in Food Technology', 'OBE Instruments', '2023-12-10 04:20:19', '0000-00-00 00:00:00');
...
CREATE TABLE IF NOT EXISTS `t_instruments_sublist` (
  `ins_id` int NOT NULL AUTO_INCREMENT,
  `ins_parentid` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ins_text` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`ins_id`)
...
(1, '657587a3c8a9f', 'A. Kent', '2023-12-10 02:13:58', '2023-12-10 02:13:58'),
(2, '657587a3c8a9f', 'A. Kent', '2023-12-10 02:14:06', '2023-12-10 02:14:06'),
(3, '657587a3c8a9f', 'A. 1 Kentxxxx', '2023-12-10 10:52:09', '2023-12-10 02:14:34'),
(5, '65759770f1326', 'A.1 Kentx', '2023-12-10 11:53:43', '2023-12-10 03:53:43'),
(14, '6575ab4c8ffe2', 'wewe', '2023-12-10 04:13:04', '2023-12-10 04:13:04');

-- --------------------------------------------------------

--
-- Table structure for table `t_parameters`
--

DROP TABLE IF EXISTS `t_parameters`;
CREATE TABLE IF NOT EXISTS `t_parameters` (
  `param_id` int NOT NULL AUTO_INCREMENT,
  `param_instrumentid` int NOT NULL,
  `param_areaid` int NOT NULL,
  `param_text` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
--
-- Dumping data for table `t_parameters`
--

INSERT INTO `t_parameters` (`param_id`, `param_instrumentid`, `param_areaid`, `param_text`, `created_at`, `updated_at`) VALUES
(1, 3, 1, 'Parameter A: Local Development', '2023-12-10 07:14:52', '0000-00-00 00:00:00'),
(2, 2, 1, 'PARAMETER A: STATEMENT OF VISION, MISSION, GOALS AND OBJECTIVES', '2023-12-10 07:48:58', '0000-00-00 00:00:00'),
(3, 2, 1, 'PARAMETER B: DISSEMINATION AND ACCEPTABILITY', '2023-12-10 07:49:04', '0000-00-00 00:00:00');
...
(7, 'Bachelor of Science in Infromation Technology', 'Undergraduate', 'Level I', '3.00', '2023-12-31', '2023-12-09 18:31:13', '2023-12-09 18:31:13');
...
INSERT INTO `t_program_instruments_sub` (`ins_id`, `ins_parentid`, `ins_text`, `ins_level`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `t_program_instruments_sublist` (`ins_id`, `ins_parentid`, `ins_text`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `t_statements`
--

DROP TABLE IF EXISTS `t_statements`;
CREATE TABLE IF NOT EXISTS `t_statements` (
  `st_id` int NOT NULL AUTO_INCREMENT,
  `st_instrumentid` int NOT NULL,
  `st_areaid` int NOT NULL,
  `st_parameterid` int NOT NULL,
  `st_statementid` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `st_text` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `st_type` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`st_id`)
...
--
-- Dumping data for table `t_statements`
--

INSERT INTO `t_statements` (`st_id`, `st_instrumentid`, `st_areaid`, `st_parameterid`, `st_statementid`, `st_text`, `st_type`, `created_at`, `updated_at`) VALUES
(18, 2, 1, 2, '657587a3c8a9f', 'A. Kent2', 'SYSTEM INPUT', '2023-12-10 10:43:54', '2023-12-10 02:43:54'),
(20, 2, 1, 2, '657588812b07c', 'A. Kent', 'IMPLEMENTATION', '2023-12-10 01:44:33', '2023-12-10 01:44:33'),
(21, 2, 1, 2, '6575888592884', 'A. Kent', 'OUTCOME', '2023-12-10 01:44:37', '2023-12-10 01:44:37'),
(22, 3, 1, 1, '65759770f1326', 'A. Kent', 'SYSTEM INPUT', '2023-12-10 02:48:16', '2023-12-10 02:48:16'),
(23, 3, 1, 1, '657597850cdb8', 'B. KENT', 'SYSTEM INPUT', '2023-12-10 02:48:37', '2023-12-10 02:48:37'),
(24, 3, 1, 1, '6575ab4c8ffe2', 'XXX', 'IMPLEMENTATION', '2023-12-10 04:13:00', '2023-12-10 04:13:00');
